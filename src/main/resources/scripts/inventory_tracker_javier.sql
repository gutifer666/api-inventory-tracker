...
-- transactions
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (1, 'Empleado de Pruebas', 'Juan Pérez', 'GEN001', 'Bicicleta', 1, 500, '2023-12-01 09:30:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (2, 'Empleado de Pruebas', 'María López', 'ELEC001', 'Smartphone', 2, 600, '2023-12-02 11:45:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (3, 'Empleado de Pruebas', 'Carlos Gómez', 'ROPA001', 'Camiseta', 3, 150, '2023-12-03 14:20:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (4, 'Empleado de Pruebas', 'Ana Martínez', 'ALIM001', 'Leche', 5, 10, '2023-12-04 16:15:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (5, 'Empleado de Pruebas', 'Pedro Sánchez', 'GEN002', 'Silla', 2, 60, '2023-12-05 10:00:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (6, 'Empleado de Pruebas', 'Laura Fernández', 'ELEC002', 'Tablet', 1, 150, '2023-12-06 13:30:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (7, 'Empleado de Pruebas', 'Miguel Torres', 'ROPA002', 'Pantalón', 2, 120, '2023-12-07 15:45:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (8, 'Empleado de Pruebas', 'Carmen Ruiz', 'ALIM002', 'Pan', 10, 10, '2023-12-08 09:10:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (9, 'Empleado de Pruebas', 'Pablo Díaz', 'GEN003', 'Mesa', 1, 80, '2023-12-09 12:25:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (10, 'Empleado de Pruebas', 'Isabel Moreno', 'ELEC003', 'Smartwatch', 3, 360, '2023-12-10 17:00:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (11, 'Empleado de Pruebas', 'Javier Ortiz', 'ROPA003', 'Vestido', 1, 100, '2023-12-11 11:30:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (12, 'Empleado de Pruebas', 'Lucía Vega', 'ALIM003', 'Refresco', 6, 15, '2023-12-12 14:45:00');
INSERT INTO inventory_tracker.transactions (id, employee_name, client_name, product_code, product_name, quantity, transaction_price, created_at) VALUES (13, 'Empleado de Pruebas', 'Guti Cliente', 'GEN001', 'Bicicleta', 1, 200, '2025-05-02 12:34:30');
